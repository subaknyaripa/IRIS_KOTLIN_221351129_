package com.example.iris_kotlin_221351129_
...
class MainActivity : AppCompatActivity() {
    ...
    private fun doInference(input1: String, input2: String, input3: String, input4: String): Int {
        ...
        val inputVal1 = input1.toFloat()
        val inputVal2 = input2.toFloat()
        val inputVal3 = input3.toFloat()
        val inputVal4 = input4.toFloat()
